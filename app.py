...
for consulta in consultas:
    ...
    try:
        ...
        print(
            f"[ML] {consulta}: "
            f"{len(resultados)} produtos encontrados"
        )
...
try:
    ...
    print(
        f"[ML] Erro consultando {item_id}: {e}"
    )
...
try:
    ...
    if not produtos:
        ...
        <p>
            A busca não encontrou produtos.
        </p>
